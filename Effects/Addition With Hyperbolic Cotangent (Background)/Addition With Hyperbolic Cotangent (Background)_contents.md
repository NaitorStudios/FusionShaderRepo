...
- **Addition With Hyperbolic Cotangent (Background).premultiplied.fxc** — DirectX11 compiled (Premultiplied*)
- **Addition With Hyperbolic Cotangent (Background).fxao** — Android source code
- **Addition With Hyperbolic Cotangent (Background).fxmo** — iOS/Mac source code
