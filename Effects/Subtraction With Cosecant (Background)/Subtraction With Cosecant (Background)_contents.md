...
Subtraction With Cosecant (Background).premultiplied.fxc - DirectX11 compiled (Premultiplied*)
Subtraction With Cosecant (Background).fxao - Android source code
Subtraction With Cosecant (Background).fxmo - iOS/Mac source code
