...
- **Correction With Reciprocal Square Root (Switch).premultiplied.fxc** — DirectX11 compiled (Premultiplied*)
- **Correction With Reciprocal Square Root (Switch).fxao** — Android source code
- **Correction With Reciprocal Square Root (Switch).fxmo** — iOS/Mac source code
