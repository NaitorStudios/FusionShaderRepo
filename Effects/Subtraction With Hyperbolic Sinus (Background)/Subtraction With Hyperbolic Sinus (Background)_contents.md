...
- **Subtraction With Hyperbolic Sinus (Background).premultiplied.fxc** — DirectX11 compiled (Premultiplied*)
- **Subtraction With Hyperbolic Sinus (Background).fxao** — Android source code
- **Subtraction With Hyperbolic Sinus (Background).fxmo** — iOS/Mac source code
