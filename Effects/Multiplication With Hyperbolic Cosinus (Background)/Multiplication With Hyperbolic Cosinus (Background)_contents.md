...
Multiplication With Hyperbolic Cosinus (Background).premultiplied.fxc - DirectX11 compiled (Premultiplied*)
Multiplication With Hyperbolic Cosinus (Background).fxao - Android source code
Multiplication With Hyperbolic Cosinus (Background).fxmo - iOS/Mac source code
