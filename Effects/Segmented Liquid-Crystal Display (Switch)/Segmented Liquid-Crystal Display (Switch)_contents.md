...
Segmented Liquid-Crystal Display (Switch).premultiplied.fxc - DirectX11 compiled (Premultiplied*)
Segmented Liquid-Crystal Display (Switch).fxao - Android source code
Segmented Liquid-Crystal Display (Switch).fxmo - iOS/Mac source code
