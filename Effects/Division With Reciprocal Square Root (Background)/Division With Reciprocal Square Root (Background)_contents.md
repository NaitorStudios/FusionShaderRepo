...
- **Division With Reciprocal Square Root (Background).premultiplied.fxc** — DirectX11 compiled (Premultiplied*)
- **Division With Reciprocal Square Root (Background).fxao** — Android source code
- **Division With Reciprocal Square Root (Background).fxmo** — iOS/Mac source code
