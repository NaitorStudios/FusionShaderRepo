...
PS_OUTPUT ps_main( in PS_INPUT In )
{
  ...
  PS_OUTPUT OutD;
	...
	OutC.Color = Tex0.Sample(Tex0Sampler, float2(In.texCoord.x+cos(_fAngle)*fCoeff*0.66,In.texCoord.y+sin(_fAngle)*fCoeff*0.5));
	OutD.Color = Tex0.Sample(Tex0Sampler, float2(In.texCoord.x-cos(_fAngle)*fCoeff*0.66,In.texCoord.y-sin(_fAngle)*fCoeff*0.5));
...
PS_OUTPUT ps_main_pm( in PS_INPUT In )
{
  ...
  PS_OUTPUT OutD;
	...
	OutC.Color = GetColorPM(float2(In.texCoord.x+cos(_fAngle)*fCoeff*0.66,In.texCoord.y+sin(_fAngle)*fCoeff*0.5));
	OutD.Color = GetColorPM(float2(In.texCoord.x-cos(_fAngle)*fCoeff*0.66,In.texCoord.y-sin(_fAngle)*fCoeff*0.5));
