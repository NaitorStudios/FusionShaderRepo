...
- **Subtraction With Hyperbolic Tangent (Background).premultiplied.fxc** — DirectX11 compiled (Premultiplied*)
- **Subtraction With Hyperbolic Tangent (Background).fxao** — Android source code
- **Subtraction With Hyperbolic Tangent (Background).fxmo** — iOS/Mac source code
